...
public enum AiPlayerNames {
  ...
  SAMANTHA_HILLS, MARVIN_THE_STUPID, SOFIA_JUDGEMENT, ALDWYN_THE_COFFEE_POT, 
  CNUT_THE_GREAT, WILLIAM_THE_CONQUEROR, LORD_VOLDEMORT, EMPRESS_MATILDA,  KUNG_FU_PANDA, 
  EDWY_THE_FAIR, EDGAR_THE_PEACEABLE, ST_EDWARD_THE_MARTYR, OSCAR_THE_GREAT, KNOX_LEON_OF_DURNINGHAM,
  EDMUND_IRONSIDE, RICCIARDA_THE_WOMAN, ROBOBOBOBOBOT, RODOLPHO_AGOSTO, ERIC_THE_MEMORABLE,
  PRESTORIUS_OF_EGGENBURGH, BJORN_IRONSIDE, SPONGEBOB,  EGIL_SKALLAGRIMSSON, EINSTEIN_THE_BRAIN,
  MEISTER_PROPER, 
  URSULA_THE_SNAKE, CINDERELLA, YOSHI, ANGELINA_THE_MOM, SIGFRID_THE_SAPIENT, BOB_THE_BUILDER,
  ...
  ALFREDO_THE_DISHWASHER, BOMBADO, MISS_MARPLE, ADVOCADO, BEAT_THE_BEAT, MAYA_THE_BEE,
  ERWIN_THE_KID, GUNDULA_THE_BIG, BOWSER, PEACH, SUPER_MARIO, SUN_KING, THE_METZELER,
  VALDEMAR_THE_YOUNG, FREYDIS_EIRIKSDOTTIR, IVAR_THE_BONELESS, KONFUZIUS;
