...
//TODO
  ...
  public static String chat = "This is the chat. To talk to all players, write your message into the message box and hit send. To send a message privately to another player, enter their name into the @Name box.";
  
  //Rule Book
  public static String ruleBook = 
      "1 Overview\n Risk​ is a strategy board game of diplomacy, conflict and conquest for two to six players.\n" + 
      "The standard version is played on a board depicting a political map of the earth, divided into\n" + 
      ...
      "The player who will start the game and make his first move will be determined by random. They\n" + 
      "will then choose an open territory and place armies on it.\n" + 
      "Each player will take turns selecting an open territory until all territories are occupied.\n" + 
      "Once players have claimed all the 42 territories on the board, players place their remaining\n" + 
      ...
      "● 2 armies = 2 dice\n" +
      "● 3 armies = 3 dice\n\n" +
      "You roll up to three red dice, depending on your troop size. The defending player rolls the\n" + 
      ...
      "with three armies.\n\n" + 
      "If at the end of your attacking turn you've conquered at least one territory, then you have\n" + 
